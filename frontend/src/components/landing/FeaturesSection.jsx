...
function VersionsPreview() {
  ...
  return (
    <div className="rounded-2xl bg-[var(--surface-2)] border border-[var(--border)] p-3 sm:p-4 flex items-center gap-1.5 sm:gap-2">
      {versions.map((v, i) => (
        <div
          key={v.label}
          className={`flex-1 rounded-xl p-2 sm:p-2.5 ${
            i === versions.length - 1
