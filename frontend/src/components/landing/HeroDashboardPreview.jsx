...
export function HeroDashboardPreview() {
  return (
    <div className="relative w-full h-[600px] sm:h-[520px]">
      {/* Main gauge card */}
      <motion.div
      ...
      <motion.div
        ...
        className="absolute top-[260px] sm:top-auto sm:bottom-10 left-1/2 -translate-x-1/2 sm:left-0 sm:translate-x-0 w-[280px] sm:w-[230px] rounded-[18px] backdrop-blur border border-white/[0.08] p-4 overflow-hidden"
        style={{
          background:
      ...
      <motion.div
        ...
        className="absolute top-[400px] sm:top-auto sm:bottom-4 left-1/2 -translate-x-1/2 sm:left-auto sm:right-0 sm:translate-x-0 w-[280px] sm:w-[260px] rounded-[18px] backdrop-blur border border-white/[0.08] p-4 overflow-hidden"
        style={{
          background:
            "linear-gradient(155deg, rgba(31,42,36,0.95) 0%, rgba(22,24,29,0.95) 50%, rgba(15,17,21,0.95) 100%)",
          boxShadow:
