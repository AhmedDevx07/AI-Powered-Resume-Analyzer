    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-4 px-3 sm:px-4 py-2">
          <Link to="/hero" className="flex items-center gap-2.5 pl-1">
            <AILogo />
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/register"
              className="hidden sm:inline-flex group items-center gap-1.5 h-9 pl-4 pr-3.5 rounded-full bg-[var(--ink)] text-[var(--bg)] text-[13px] font-semibold hover:opacity-90 active:scale-[0.98] transition-all"
            >
              Get started
              <ArrowRight
                size={13}
        ...
        {open && (
          ...
          >
            ...
            <Link
              to="/register"
              className="block mt-2 px-3 py-2 rounded-xl text-sm font-semibold bg-[var(--ink)] text-[var(--bg)] text-center hover:opacity-90 transition-opacity"
              onClick={() => setOpen(false)}
            >
              Get started
            </Link>
