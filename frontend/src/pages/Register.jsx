...
import { ArrowRight, Loader2, User, Mail, Lock, ArrowLeft } from "lucide-react";
import {
  AuthShell,
  AuthField,
  AuthPrimaryButton,
    ...
    >
      ...
      >
        <div className="mb-6">
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 text-xs font-medium text-[var(--ink-muted)] hover:text-[var(--ink)] transition-colors group"
          >
